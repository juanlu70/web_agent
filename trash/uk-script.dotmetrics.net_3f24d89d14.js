    ...
    if (window.DotMetricsInitScript == undefined) {
        ...
        function start(hasConsent){
            ...
            var doorUrl = 'http%3a%2f%2fuk-script.dotmetrics.net%2fdoor.js%3fd%3dwww.pcgamer.com%26t%3dpcg';
            ...
            if(!hitDone){
                ...
                var imgUrl = 'https://uk-script.dotmetrics.net/hit.gif?id=5217&url=' + pageUrl + '&dom=' + domain + '&r=' + rand + '&pvs=' + pvs + '&ecid=' + ecid + dcOpt + '&c=' + hasConsent + '&tzOffset=' + tzOffset + '&doorUrl=' + doorUrl + '&dfph=' + domainFph+'&ver=362';
                if(sf2!=null){imgUrl+='&sf2='+sf2;}
                var im=new Image;
                im.src = imgUrl;
                im.onload = function (){im.onload=null};

                var panelImgUrl = 'https://rm-script.dotmetrics.net/hit.gif?id=5217&url=' + pageUrl + '&dom=' + domain + '&r=' + rand + '&pvs=' + pvs + '&pvid=' + ecid + '&c=' + hasConsent + '&tzOffset=' + tzOffset;
                        ...
                        window.DotMetricsSettings =
                            {
                                ...
                                ScriptUrl:  'https://uk-script.dotmetrics.net/Scripts/script.js?v=362',
                                ScriptDebugUrl:  'https://download.dotmetrics.net/Script/script.debug.js?v=4cbee1fb-6f87-4707-b883-19b6d9940583',
                                NCSScriptUrl: 'https://uk-script.dotmetrics.net/Scripts/ncs-script.js?v=362',
                                NCSScriptDebugUrl: 'https://download.dotmetrics.net/Script/ncs-script.debug.js?v=d97f4875-1888-4380-935f-0043939baeff',
                                AdexConfigUrl: 'https://script.api/DotMetrics.Script.Adex/adexConfig.js?v=362&id=5217',
                                SiteSectionId: 5217,
                                SiteId: 939,
